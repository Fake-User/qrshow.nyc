...
let retrospectiveContent = readFileSync(`${path}/src/retrospective.html`, "utf-8")
    ...
    .replace('/assets/cube.gif', `data:image/gif;base64,${readFileSync(`${path}/src/assets/cube.gif`).toString("base64")}`)
...
let escapeContent = readFileSync(`${path}/src/escape.html`, "utf-8")
    ...
    .replace(`href="/assets/qrshow.png"`, `href="data:image/png;base64,${readFileSync(`${path}/src/assets/qrshow.png`).toString("base64")}"`)
    .replace(`src="/assets/recurse.png"`, `src="data:image/png;base64,${readFileSync(`${path}/src/assets/recurse.png`).toString("base64")}"`)
    .replace(`src="/assets/favicon.gif"`, `src="data:image/png;base64,${readFileSync(`${path}/src/assets/favicon.gif`).toString("base64")}"`)

...
let retrospectiveContent = readFileSync(`${path}/src/retrospective.html`, "utf-8")
    .replace(`url("/assets/autonomous-response.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/autonomous-response.png`).toString("base64")}")`)
    .replace(`url("/assets/balanced-breakfast.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/balanced-breakfast.png`).toString("base64")}")`)
    .replace(`url("/assets/quasi-recursion.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/quasi-recursion.png`).toString("base64")}")`)
    .replace(`url("/assets/receipt-loom.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/receipt-loom.png`).toString("base64")}")`)
    .replace(`url("/assets/ogcourier.woff2")`, `url("data:font/woff2;base64,${readFileSync(`${path}/src/assets/ogcourier.woff2`).toString("base64")}")`)
    .replace(`url("/assets/god-encoder.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/god-encoder.png`).toString("base64")}")`)
    .replace(`url("/assets/qrspectives.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/qrspectives.png`).toString("base64")}")`)
    .replace(`url("/assets/between-us.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/between-us.png`).toString("base64")}")`)
    .replace(`url("/assets/anaqronism.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/anaqronism.png`).toString("base64")}")`)
    .replace(`url("/assets/sol-lewitt.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/sol-lewitt.png`).toString("base64")}")`)
    .replace('src="/assets/ogbasilisk.gif"', `src="data:image/gif;base64,${readFileSync(`${path}/src/assets/ogbasilisk.gif`).toString("base64")}"`)
    .replace(`url("/assets/qr-trivia.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/qr-trivia.png`).toString("base64")}")`)
    .replace(`url("/assets/guestbook.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/guestbook.png`).toString("base64")}")`)
    .replace(`url("/assets/human-qr.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/human-qr.png`).toString("base64")}")`)
    .replace(`href="/assets/favicon.png"`, `href="data:image/png;base64,${readFileSync(`${path}/src/assets/favicon.png`).toString("base64")}"`)
    .replace(`url("/assets/letters.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/letters.png`).toString("base64")}")`)
    .replace(`url("/assets/qr-life.png")`, `url("data:image/gif;base64,${readFileSync(`${path}/src/assets/qr-life.png`).toString("base64")}")`)
    .replace('src="/assets/cube.gif"', `src="data:image/gif;base64,${readFileSync(`${path}/src/assets/cube.gif`).toString("base64")}"`)
